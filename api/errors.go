...
import (
	...
	"github.com/bytom/bystack/blockchain/signers"
	"github.com/bytom/bystack/blockchain/txbuilder"
	"github.com/bytom/bystack/contract"
	"github.com/bytom/bystack/errors"
	"github.com/bytom/bystack/net/http/httperror"
...
var respErrFormatter = map[error]httperror.Info{
	ErrDefault: {500, "BTM000", "Bystack API Error"},
...
var errorFormatter = httperror.Formatter{
	Default:     httperror.Info{500, "BTM000", "Bystack API Error"},
