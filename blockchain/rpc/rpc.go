...
import (
	...
	"github.com/bytom/bystack/net/http/reqid"
)

// Bystack-specific header fields
const (
	HeaderBlockchainID = "Blockchain-ID"
	HeaderCoreID       = "Bystack-Core-ID"
...
// A Client is a Bystack RPC client. It performs RPCs over HTTP using JSON
...
func (c Client) userAgent() string {
	return fmt.Sprintf("Bystack; process=%s; buildtag=%s; blockchainID=%s",
